...
# nginx.com/nginx-lb-operator-bundle:$VERSION and nginx.com/nginx-lb-operator-catalog:$VERSION.

IMAGE_TAG_BASE ?= repository-name/image-name  #tuxinvader/nginx-lb-operator
